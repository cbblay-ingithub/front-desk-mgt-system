...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo">
        <a href="frontdesk_dashboard.php"
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item <?= ($currentPage == 'frontdesk_dashboard.php') ? 'active' : '' ?>">
            <a href="frontdesk_dashboard.php" class="menu-link" data-tooltip="Dashboard">
        ...
        <!-- Manage Visitors -->
        <li class="menu-item <?= ($currentPage == 'visitor-mgt.php') ? 'active' : '' ?>">
            <a href="visitor-mgt.php" class="menu-link" data-tooltip="Manage Visitors">
                <i class="menu-icon icon-base bx bx-user"></i>
                <div data-i18n="Manage Visitors">Manage Visitors</div>
            </a>
        </li>

        <!-- Appointments -->
        <li class="menu-item <?= ($currentPage == 'FD_frontend_dash.php') ? 'active' : '' ?>">
            <a href="FD_frontend_dash.php" class="menu-link" data-tooltip="Appointments">
        ...
        <!-- Tickets -->
        <li class="menu-item <?= ($currentPage == 'FD_tickets.php') ? 'active' : '' ?>">
            <a href="FD_tickets.php" class="menu-link" data-tooltip="Tickets">
                <i class="menu-icon icon-base bx bx-message-square-detail"></i>
                <div data-i18n="Tickets">Manage Tickets</div>
            </a>
        </li>
